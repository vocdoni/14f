    ...
    return (
        <Layout>
            ...
            <div className="grid grid-cols-4 gap-4 px-4 sm:px-6 md:px-8 mb-14 sm:mb-20 xl:mb-8">
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🍍<div className="pt-1 text-xs">CUP</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                ...
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🍅<div className="pt-1 text-xs">IZQ</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🍉<div className="pt-1 text-xs">RECORTES CERO</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🧄<div className="pt-1 text-xs">UEP</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🧁<div className="pt-1 text-xs">PUM+J</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🥟<div className="pt-1 text-xs">ALIANZA C V</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🌽<div className="pt-1 text-xs">SCAT</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🍙<div className="pt-1 text-xs">SOM TERRES DE L'EBRE</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🍄<div className="pt-1 text-xs">MCR</div>
                </button>
                <button className="px-4 py-4 text-3xl shadow bg-translucent">
                    🥘<div className="pt-1 text-xs">UNIDOS SI</div>
                </button>
            </div>
        </Layout>
    );
