...
// const mergeData = (results: AggregatedResults) => {
//     const data = []
        ...
        voteResults: [
            {
                ...
                votes: BigNumber.from(250),
            },
            {
                title: {
                    default: 'erc'
                },
                votes: BigNumber.from(1250),
            },
            {
                title: {
                    default: 'pdecat'
                },
                votes: BigNumber.from(1000),
            },
            {
                title: {
                    default: 'cup'
                },
                votes: BigNumber.from(2500),
            },
            {
                title: {
                    default: 'jxcat'
                },
                votes: BigNumber.from(1200),
            },
            {
                title: {
                    default: 'cs'
                },
                votes: BigNumber.from(120),
            },
            {
                title: {
                    default: 'ecp'
            ...
            },
            {
                ...
                votes: BigNumber.from(4643),
            },
            {
                title: {
                    default: 'blank'
                },
                votes: BigNumber.from(2986),
            },
        ],
    },
    girona: {
        voteResults: [
            {
                ...
                votes: BigNumber.from(136),
            },
            {
                title: {
                    default: 'erc'
                },
                votes: BigNumber.from(2250),
            },
            {
                title: {
                    default: 'pdecat'
                },
                votes: BigNumber.from(1600),
            },
            {
                title: {
                    default: 'cup'
                },
                votes: BigNumber.from(2900),
            },
            {
                title: {
                    default: 'jxcat'
            ...
            },
            {
                ...
                votes: BigNumber.from(190),
            },
            {
                title: {
                    default: 'ecp'
                },
                votes: BigNumber.from(260),
            },
            {
                title: {
                    default: 'vox'
                },
                votes: BigNumber.from(390),
            },
            {
                title: {
                    default: 'pctc'
                },
                votes: BigNumber.from(1387),
            },
            {
                title: {
                    default: 'mpic'
                },
                votes: BigNumber.from(1369),
            },
            {
                title: {
                    default: 'void'
