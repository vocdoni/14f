...
export default function Home() {
    return (
        <Layout>
            <header>
                <h1 className="mt-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 sm:text-6xl lg:text-6xl sm:mt-12 sm:mb-8">
            ...
            <div className="grid grid-cols-10 gap-8 space-y-4 text-center sm:space-y-0 sm:space-x-4">
                ...
                <div className="col-span-8 px-4 py-4 text-md leading-6 text-blue-800 bg-blue-100 border border-transparent rounded-xl">
