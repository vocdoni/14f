    ...
    return (
        <Container>
            ...
            <div className="text-sm lg:text-base">
                ...
                <dl className="grid grid-cols-1 gap-2 mb-6 text-sm lg:grid-cols-4">
                ...
                <div className="text-left lg:text-right">
                    ...
                    <button
                        disabled={!accepted}
                        onClick={onAccept}
                        className="inline-flex items-center w-full col-span-1 text-xl md:col-span-2 main-action lg:w-44"
                    >
